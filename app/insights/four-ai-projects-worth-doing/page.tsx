          ...
          <div className="mt-12 border-t border-[var(--white-20)] pt-10">
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <Link href="/insights/why-most-ai-pilots-fail" className="block py-2 text-sm text-[var(--white-80)] hover:text-[var(--white-100)]">
                  Why most AI pilots fail →
                </Link>
                <Link href="/insights/document-automation-where-to-start" className="block py-2 text-sm text-[var(--white-80)] hover:text-[var(--white-100)]">
