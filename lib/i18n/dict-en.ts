...
export const en = {
  ...
  services: {
    ...
    intro:
      "We focus on simple, fast-to-ship AI services that solve real workflow problems without turning the first engagement into a large transformation project.",
    duration: "DURATION",
    scope: "SCOPE",
    items: [
      {
