...
export const en = {
  ...
  caseStudiesPage: {
    ...
    cases: [
      {
        number: "01",
        sector: "AGRICULTURE · NATIONAL NETWORK",
        ...
        capabilities: [
          ...
          { name: "Salesforce-Native Quote Drafting", body: "The diagnosis becomes a structured quotation in Salesforce, including alternatives and substitution rules, ready for consultant sign-off." },
        ],
        outcomes: [
          { metric: "< 30 sec", label: "field-to-quote workflow (previously ~40 minutes)" },
          { metric: "20,000+", label: "products available to the recommendation engine" },
          { metric: "3", label: "AI agents operating on one shared backend" },
          { metric: "1", label: "auditable trail from diagnosis to quotation" },
        ],
      },
      {
        number: "02",
        ...
        capabilities: [
          { name: "Unified Borrower Intelligence", body: "Customer 360 profiles, exact-identity search, loan history, overdue status, and cross-company exposure are available from one authorised view." },
          { name: "End-to-End Lending Workflow", body: "Applications move through verification, lender-configured scoring, human approval, agreements, repayment schedules, and collections without losing the source record." },
          { name: "Auditable AI Assistance", body: "Credit summaries, email intake, document processing, and staff queries operate on live portal data while final lending decisions remain with authorised people." },
        ],
        outcomes: [
          { metric: "17,000+", label: "borrower records supported across corporate clients" },
          { metric: "3-in-1", label: "management portal, staff tools, and client app" },
          { metric: "One", label: "permission-scoped borrower and exposure view" },
          { metric: "End to end", label: "from enquiry intake to final repayment" },
        ],
      },
      {
        number: "03",
        ...
        capabilities: [
          ...
          { name: "Cantonal Compliance Reporting", body: "Monthly regulatory reports are compiled from the underlying care records in the required format, ready for senior review." },
        ],
        outcomes: [
