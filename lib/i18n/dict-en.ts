    ...
    items: [
      {
        ...
        subsLabel: "AI Adoption & Integration",
        subs: [
          "Payment gateway/processing integrations (card acquiring, orchestration)",
          ...
          "RegTech / compliance automation (transaction monitoring, reporting)",
          "Embedded finance / Banking-as-a-Service (BaaS) integrations",
          "Expense management & corporate card platforms",
          "Invoice factoring / supply chain finance platforms",
          "Credit card processing & tokenization services",
          "Open banking / account aggregation (Plaid-like) integrations",
          "Treasury management & cash flow forecasting tools",
          "Subscription billing & revenue recognition platforms",
          "Chargeback/dispute management systems",
  ...
  aboutPage: {
    ...
    team: {
      ...
      members: [
        ...
        { name: "Stanislav Dupllyakov", role: "Switzerland Customer Relations", photo: "/team/stanislav-dupllyakov-800.webp", initials: "SD", bio: "" },
  ...
  caseStudiesPage: {
    ...
    cases: [
      ...
      },
      {
        ...
        challenge: "A professional services firm with 140 employees had 8 years of internal documentation spread across Confluence, SharePoint, and shared drives — procedures, client methodologies, compliance frameworks, and project templates. New hires took 2–3 weeks to become productive. Senior staff were interrupted 12–18 times per day answering internal questions that existing documentation already covered.",
        solution: "DeView built a permission-controlled internal knowledge assistant that ingests and indexes the firm's entire document library. Staff ask questions in natural language; the assistant searches across all connected sources and returns cited answers pointing to the specific document section. Access is scoped by role — junior staff cannot retrieve materials outside their clearance level.",
        outcomes: [
        ...
        quote: "We didn't realise how much senior time was going to questions that were already answered somewhere. Now we can see exactly which documents are getting used — and which ones need updating.",
      ...
      },
      {
        ...
        challenge: "A Hong Kong financial services company produced a weekly management pack covering pipeline performance, risk flags, and market commentary. Four team members spent a combined 9 hours each week pulling data from five different systems, formatting it into a standard template, and writing narrative summaries. The report was frequently late and occasionally contained reconciliation errors.",
        solution: "DeView connected the AI to the company's SQL databases, BI tools, and internal data feeds via read-only service accounts. A scheduled job runs each Friday morning: the system pulls the prior week's data, runs the standard calculations, generates the narrative summaries using the company's approved commentary format, and delivers a complete first-draft report. The team reviews, adjusts commentary as needed, and signs off.",
        outcomes: [
        ...
        quote: "Friday mornings used to be chaos. Now the draft is in our inbox before we arrive. We spend 20 minutes reviewing instead of a full day building.",
      ...
      },
      {
        ...
        capabilities: [
          { name: "Field Report Automation", body: "WhatsApp messages, photos, and email attachments from field engineers automatically classified by site, report type, and urgency. Structured data extracted and written to the central project tracker — no manual copy-pasting required." },
          { name: "Multi-Format Donor Reporting", body: "Connected to 12 active grant databases with each donor's required KPI format pre-configured. One-click report generation produces compliant drafts — USAID, EU, and private foundation formats all handled automatically." },
          { name: "Construction Standards Knowledge Base", body: "Building codes, seismic standards, material specifications, and IRVA's own field playbooks indexed across 30+ countries. Volunteers query in natural language and receive cited answers with links to the regulatory source document." },
        ],
        quote: "Our reporting coordinator used to disappear for two weeks every quarter just to produce donor reports. Now she generates all twelve in a single morning and spends the rest of her time on what actually matters — getting materials to sites faster.",
      ...
      },
      {
        ...
        capabilities: [
          { name: "Multi-Document Extraction & Validation", body: "Bills of lading, commercial invoices, packing lists, and customs declarations automatically classified, extracted, and cross-validated. HS codes checked against destination-market tariff schedules. Discrepancies flagged before submission — not after." },
          { name: "Trade Lane Knowledge Base", body: "Customs regulations, restricted-goods lists, and tariff schedules across 40+ markets indexed and kept current. Staff ask 'What are the labelling requirements for electronics entering Brazil?' and get the answer with regulatory citation — no portal-hunting required." },
          { name: "Real-Time Shipment Support", body: "Client-facing assistant connected to tracking systems, carrier APIs, and the document archive. Answers status, ETA, and document requests instantly across email and web chat — handling 70% of enquiries without human involvement." },
        ],
        quote: "We used to have six people doing nothing but typing numbers from one document into another system. Now the data flows automatically and my team focuses on the shipments that actually need human judgment — the exceptions, the customs holds, the urgent re-routes.",
      ...
      },
      {
        ...
        capabilities: [
          { name: "Contract Analysis & Clause Extraction", body: "Deal documents automatically parsed for key commercial terms — purchase price mechanics, conditions precedent, representations, indemnity caps, restrictive covenants, and change-of-control provisions. Non-standard terms flagged against the firm's clause library with specific deviation highlighted." },
          { name: "Precedent Search & Citation", body: "Eight years of firm work product — opinions, negotiation memos, template clauses, and regulatory guidance — indexed with semantic search. Lawyers query in natural language and receive cited results linking to the exact document section. Access scoped by seniority and matter confidentiality." },
          { name: "Automated Client Reporting", body: "Weekly matter updates and billing narratives generated from time entries, milestone records, and status notes. Partners review a complete draft in 10 minutes instead of writing from scratch — freeing 3–4 hours per week for substantive legal work." },
        ],
        quote: "Our junior associates used to spend three days reading contracts before I could even begin to assess the risk. Now I have a structured comparison matrix on my desk the same afternoon — and the associates are doing real legal analysis instead of data entry.",
      ...
      },
      {
        ...
        capabilities: [
          { name: "Multilingual Guest Assistant", body: "Real-time support in English, Mandarin, Thai, and Japanese across email, web chat, and OTA channels. Connected to PMS for live availability, pricing, and booking confirmation. Handles enquiries from room type comparisons to spa reservations — escalating complex requests with full context attached." },
          { name: "Vendor Invoice Automation", body: "Purchase orders, delivery receipts, and supplier invoices across 40+ vendors automatically matched, validated, and reconciled. Price discrepancies and missing deliveries flagged before payment. Payment schedules generated per property and consolidated for group finance." },
          { name: "Automated Operations Reporting", body: "Nightly property summaries and weekly ownership packs generated automatically from PMS, revenue management, review platforms, and maintenance systems. GMs review a complete draft each morning in 15 minutes — no more toggling between five dashboards." },
        ],
